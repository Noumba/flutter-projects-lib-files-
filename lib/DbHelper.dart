...
class SQLiteDbProvider {
 /* SQLiteDbProvider._();
  ...
  Future<List<Friend>> getFriendByFriendsName(int id, String name) async {
    final db = await database;

    List<Map> results = await db.query("Friends", where: "uid = ? and name LIKE ?", whereArgs: [id, name],
        /*columns: ProductCard.columns,*/ orderBy: "id DESC");
    ...
    print('All Specific searched Friends are ready');
